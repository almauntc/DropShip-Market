                  ...
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0 text-white">Rp 65,650</h3>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0 text-white">5693</h3>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card bg-info p-20">
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right text-white">Costomer</p>
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0 text-white">246</h3>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card bg-warning p-20">
                <div class="card-body">
                  <div class="clearfix">
                    <div class="float-left">
                      <i class="mdi mdi-truck text-light icon-lg"></i>
                    </div>
                    <div class="float-right">
                      <p class="mb-0 text-right text-white">Supplier</p>
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0 text-white">246</h3>
                      </div>
                    </div>
                ...
                <div class="card-body">
                  ...
                  <div class="fluid-container">
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="{{ asset('images/backend_images/faces/face1.jpg') }}" alt="profile image">
                      </div>
                    ...
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="{{ asset('images/backend_images/faces/face2.jpg') }}" alt="profile image">
                      </div>
                      <div class="ticket-details col-md-9">
                        <div class="d-flex">
                    ...
                    <div class="row ticket-card mt-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="{{ asset('images/backend_images/faces/face3.jpg') }}" alt="profile image">
                      </div>
                      <div class="ticket-details col-md-9">
                        <div class="d-flex">
