           ...
           <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-header" >
                     <h4 class="m-b-0 text-white">List Of Customers</h4>
                 </div>
                <div class="card-body">
                  <div class="form-group">
                     ...
                     <a href="{{ url('/admin/customer-management/customer/newCustomer') }}"><button class="btn btn-success btn-block col-lg-3">New Customer
